  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 animate-in fade-in duration-700">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 shadow-sm flex flex-col gap-4">
        ...
        <div className="text-sm text-blue-700 leading-relaxed italic bg-white/50 p-4 rounded-xl">
        ...
        <div className="flex justify-between items-center text-[10px] font-bold text-blue-500 uppercase tracking-tighter">
          <span>Goal: Minimize False Positives</span>
          <span className="bg-blue-100 px-2 py-1 rounded-md">Conf: {(healthy?.score * 100).toFixed(0)}%</span>
        </div>
      </div>
      ...
      <div className="bg-red-50 border border-red-100 rounded-2xl p-6 shadow-sm flex flex-col gap-4">
        ...
        <div className="text-sm text-red-700 leading-relaxed italic bg-white/50 p-4 rounded-xl">
          <ul className="list-disc pl-4 space-y-1">
        ...
        <div className="flex justify-between items-center text-[10px] font-bold text-red-500 uppercase tracking-tighter">
          <span>Goal: Minimize False Negatives</span>
          <span className="bg-red-100 px-2 py-1 rounded-md">Conf: {(disease?.score * 100).toFixed(0)}%</span>
        </div>
      </div>
    </div>
  );
